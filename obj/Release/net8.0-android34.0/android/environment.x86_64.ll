...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 115, ; uint32_t number_of_assemblies_in_apk (0x73)
	i32 0, ; uint32_t bundled_assembly_name_width (0x0)
	i32 2, ; uint32_t number_of_assembly_store_files (0x2)
	i32 510, ; uint32_t number_of_dso_cache_entries (0x1fe)
	i32 33555152, ; uint32_t android_runtime_jnienv_class_token (0x20002d0)
	i32 100670807, ; uint32_t jnienv_initialize_method_token (0x6001d57)
	i32 100670806, ; uint32_t jnienv_registerjninatives_method_token (0x6001d56)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [510 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.85_name, ; name: libaot-Mono.Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.83_name, ; name: libaot-Java.Interop.dll.so
		ptr null; void* handle (0x0)
	}, ; 22
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.84_name, ; name: libaot-Mono.Android.Runtime.dll.so
		ptr null; void* handle (0x0)
	}, ; 36
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.82_name, ; name: libaot-System.dll.so
		ptr null; void* handle (0x0)
	}, ; 75
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3513109795042567648, ; hash 0x30c112bece7525e0, from name: libaot-BYAJHISSAB.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BYAJHISSAB.dll.so
		ptr null; void* handle (0x0)
	}, ; 91
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.81_name, ; name: libaot-System.Xml.ReaderWriter.dll.so
		ptr null; void* handle (0x0)
	}, ; 96
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.86_name, ; name: libaot-System.Private.CoreLib.dll.so
		ptr null; void* handle (0x0)
	}, ; 99
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4457264300305928967, ; hash 0x3ddb6243f9c3d307, from name: BYAJHISSAB
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BYAJHISSAB.dll.so
		ptr null; void* handle (0x0)
	}, ; 118
	...
	%struct.DSOCacheEntry {
		i64 5712463910424695058, ; hash 0x4f46bfa91d1a5112, from name: libaot-BYAJHISSAB
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BYAJHISSAB.dll.so
		ptr null; void* handle (0x0)
	}, ; 140
	...
	%struct.DSOCacheEntry {
		i64 7392961044186541930, ; hash 0x669912e66d0a2f6a, from name: aot-BYAJHISSAB
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BYAJHISSAB.dll.so
		ptr null; void* handle (0x0)
	}, ; 180
	...
	%struct.DSOCacheEntry {
		i64 7979203075683016299, ; hash 0x6ebbd2ebf4ca5e6b, from name: aot-BYAJHISSAB.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BYAJHISSAB.dll.so
		ptr null; void* handle (0x0)
	}, ; 203
	...
	%struct.DSOCacheEntry {
		i64 11555929716007430670, ; hash 0xa05ee8d9cc00ea0e, from name: BYAJHISSAB.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BYAJHISSAB.dll.so
		ptr null; void* handle (0x0)
	}, ; 319
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [115 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 8
...
@.env.3 = private unnamed_addr constant [37 x i8] c"6e01fdb1-a227-46f9-a801-d67b36828c51\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [22 x i8] c"byajhissab.byajhissab\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [25 x i8] c"libaot-BYAJHISSAB.dll.so\00", align 16
...
@.DSOCacheEntry.81_name = private unnamed_addr constant [38 x i8] c"libaot-System.Xml.ReaderWriter.dll.so\00", align 16
@.DSOCacheEntry.82_name = private unnamed_addr constant [21 x i8] c"libaot-System.dll.so\00", align 16
@.DSOCacheEntry.83_name = private unnamed_addr constant [27 x i8] c"libaot-Java.Interop.dll.so\00", align 16
@.DSOCacheEntry.84_name = private unnamed_addr constant [35 x i8] c"libaot-Mono.Android.Runtime.dll.so\00", align 16
@.DSOCacheEntry.85_name = private unnamed_addr constant [27 x i8] c"libaot-Mono.Android.dll.so\00", align 16
@.DSOCacheEntry.86_name = private unnamed_addr constant [37 x i8] c"libaot-System.Private.CoreLib.dll.so\00", align 16
