...
@dso_cache = dso_local local_unnamed_addr global [510 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 526241206, ; hash 0x1f5dcdb6, from name: libaot-BYAJHISSAB.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1015254169, ; hash 0x3c838c99, from name: BYAJHISSAB.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BYAJHISSAB.dll.so
		ptr null; void* handle (0x0)
	}, ; 112
	...
	%struct.DSOCacheEntry {
		i64 1483543373, ; hash 0x586d134d, from name: BYAJHISSAB
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BYAJHISSAB.dll.so
		ptr null; void* handle (0x0)
	}, ; 172
	...
	%struct.DSOCacheEntry {
		i64 2076357267, ; hash 0x7bc2b293, from name: aot-BYAJHISSAB.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BYAJHISSAB.dll.so
		ptr null; void* handle (0x0)
	}, ; 239
	...
	%struct.DSOCacheEntry {
		i64 2799226972, ; hash 0xa6d8d05c, from name: aot-BYAJHISSAB
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BYAJHISSAB.dll.so
		ptr null; void* handle (0x0)
	}, ; 331
	...
	%struct.DSOCacheEntry {
		i64 3094666335, ; hash 0xb874dc5f, from name: libaot-BYAJHISSAB
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BYAJHISSAB.dll.so
		ptr null; void* handle (0x0)
	}, ; 380
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [115 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
